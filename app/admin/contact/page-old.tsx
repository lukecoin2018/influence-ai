              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap' }}>
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                    ...
                    {sub.status !== 'read' && (
                      <span style={{ padding: '2px 8px', borderRadius: '999px', backgroundColor: '#FFF9E0', fontSize: '11px', fontWeight: 700, color: '#FFD700' }}>NEW</span>
                    )}
                    {sub.type && (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '8px', flexShrink: 0 }}>
                  ...
                  <a
                    ...
                    style={{ padding: '5px 12px', borderRadius: '8px', fontSize: '12px', fontWeight: 600, textDecoration: 'none', backgroundColor: '#FFF9E0', color: '#FFD700' }}
                  >
                    Reply
                  </a>
                </div>
