// app/es-es/discover/page.tsx
// Spain Spanish discover index
...
export const metadata: Metadata = {
  title: 'Descubrir Influencers en España (2026) | InfluenceIT',
  description: 'Explora nuestra base de datos de creadores verificados de Instagram y TikTok en España y Madrid. Filtra por ciudad, plataforma y categoría con datos reales de engagement.',
  alternates: {
    canonical: 'https://influenceit.app/es-es/discover',
    languages: {
      'en': 'https://influenceit.app/discover',
      'es-ES': 'https://influenceit.app/es-es/discover',
    },
  },
};
  ...
  return (
    <span className="inline-flex items-center gap-1 text-xs font-medium text-pink-600 bg-pink-50 px-2 py-0.5 rounded-full">
      <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none">
        <defs>
          <linearGradient id="ig-idx-es-es" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#f09433" />
            <stop offset="100%" stopColor="#bc1888" />
          </linearGradient>
        </defs>
        <rect x="2" y="2" width="20" height="20" rx="5" fill="url(#ig-idx-es-es)" />
...
const LOCATION_PAGES = [
  { slug: 'creadores-instagram-espana', label: 'España', emoji: '🇪🇸', platform: 'instagram' },
  { slug: 'creadores-tiktok-espana', label: 'España', emoji: '🇪🇸', platform: 'tiktok' },
  { slug: 'creadores-instagram-madrid', label: 'Madrid', emoji: '🏛️', platform: 'instagram' },
  { slug: 'creadores-tiktok-madrid', label: 'Madrid', emoji: '🏛️', platform: 'tiktok' },
];

const NICHE_PAGES = [
  { slug: 'belleza-instagram-es', label: 'Belleza', platform: 'instagram', emoji: '✨' },
  { slug: 'belleza-tiktok-es', label: 'Belleza', platform: 'tiktok', emoji: '✨' },
  { slug: 'moda-instagram-es', label: 'Moda', platform: 'instagram', emoji: '👗' },
  { slug: 'moda-tiktok-es', label: 'Moda', platform: 'tiktok', emoji: '👗' },
  { slug: 'fitness-instagram-es', label: 'Fitness', platform: 'instagram', emoji: '💪' },
  { slug: 'fitness-tiktok-es', label: 'Fitness', platform: 'tiktok', emoji: '💪' },
  { slug: 'lifestyle-instagram-es', label: 'Lifestyle', platform: 'instagram', emoji: '🌿' },
  { slug: 'lifestyle-tiktok-es', label: 'Lifestyle', platform: 'tiktok', emoji: '🌿' },
  { slug: 'skincare-instagram-es', label: 'Skincare', platform: 'instagram', emoji: '🧴' },
  { slug: 'skincare-tiktok-es', label: 'Skincare', platform: 'tiktok', emoji: '🧴' },
  { slug: 'wellness-instagram-es', label: 'Wellness', platform: 'instagram', emoji: '🧘' },
  { slug: 'wellness-tiktok-es', label: 'Wellness', platform: 'tiktok', emoji: '🧘' },
];

export default function EsEsDiscoverIndexPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-14">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight max-w-2xl">
            ...
            <span style={{ color: '#FF4D94' }}>en España</span>
          </h1>
          <p className="mt-4 text-lg text-gray-500 max-w-xl leading-relaxed">
            Explora nuestra base de datos de creadores verificados de Instagram y TikTok en España y Madrid — con datos reales de engagement y audiencias auténticas.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            {[
              { icon: '📊', text: 'Datos verificados' },
              { icon: '✅', text: 'Perfiles auténticos' },
              { icon: '📍', text: 'España y Madrid' },
              { icon: '🎯', text: '6 categorías' },
            ].map((pill) => (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          <div className="mb-6">
            <h2 className="text-2xl font-extrabold text-gray-900">Por Ubicación</h2>
            <p className="text-sm text-gray-500 mt-1">Creadores verificados en España y Madrid</p>
          </div>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {LOCATION_PAGES.map((page) => (
              <Link
                key={page.slug}
                href={`/es-es/discover/${page.slug}`}
        ...
        <section className="rounded-2xl border border-gray-200 bg-gray-50 px-8 py-8">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-lg font-bold text-gray-900">¿Buscas creadores en América Latina?</p>
              <p className="text-sm text-gray-500 mt-1">Tenemos páginas específicas para Colombia, México, Perú y Chile</p>
            </div>
            <Link
              href="/es/discover"
