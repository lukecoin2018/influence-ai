    ...
    <div style={{ backgroundColor: '#FAFAFA', minHeight: '100vh' }}>
      <div className="max-w-7xl mx-auto px-6" style={{ paddingTop: '64px', paddingBottom: '96px' }}>
        ...
        <div style={{ maxWidth: '640px', marginBottom: '64px' }}>
          <h1 style={{ fontSize: '42px', fontWeight: 800, color: '#111827', margin: '0 0 16px 0', letterSpacing: '-0.03em', lineHeight: 1.1 }}>
            About InfluenceAI
          </h1>
        ...
        <div className="card" style={{ padding: '40px', marginBottom: '24px', maxWidth: '720px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#111827', margin: '0 0 12px 0' }}>Our Mission</h2>
        ...
        <div className="card" style={{ padding: '40px', marginBottom: '24px', maxWidth: '720px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#111827', margin: 0 }}>Why mid-tier creators?</h2>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
            {[
              ...
              <div key={label} style={{ textAlign: 'center', padding: '20px', backgroundColor: '#F9FAFB', borderRadius: '10px' }}>
                <p style={{ fontSize: '28px', fontWeight: 800, color: '#7C3AED', margin: '0 0 4px 0', letterSpacing: '-0.02em' }}>{value}</p>
        ...
        <div className="card" style={{ padding: '40px', marginBottom: '24px', maxWidth: '720px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#111827', margin: 0 }}>How we work</h2>
          </div>
          <p style={{ fontSize: '15px', color: '#6B7280', margin: 0, lineHeight: '1.7' }}>
        ...
        {/* Contact */}
        <div className="card" style={{ padding: '40px', maxWidth: '720px', background: 'linear-gradient(135deg, #F5F3FF 0%, #EDE9FE 100%)', border: '1px solid #DDD6FE' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#111827', margin: 0 }}>Get in touch</h2>
          </div>
          ...
          <a href="mailto:hello@influenceai.com" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '10px 20px', borderRadius: '8px', backgroundColor: '#7C3AED', color: 'white', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>
        
            <Mail size={14} />
            hello@influenceai.com
          </a>
        </div>
